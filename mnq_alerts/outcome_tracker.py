...
price moves 8 points in the recommended direction.
A recommendation is incorrect if price hits the line but fails to reach the
+8 target within 15 minutes.
